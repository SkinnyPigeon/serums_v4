...
fcrb_healthcare_providers_3 = {'tag': 'healthcare_providers', 'source': 'fcrb.medical_specialty', 'fields': ['orgid', 'orgna'], 'key_lookup': {'table': 'fcrb.order_entry', 'key': 'orgid'}, 'table': True, 'graph': False, 'image': False}
...
fcrb_additional_information_4 = {'tag': 'additional_information', 'source': 'fcrb.professional', 'fields': ['erusr', 'orgid', 'gbdat', 'begdt', 'enddt'], 'key_lookup': {'table': 'fcrb.episode', 'key': 'pernr'}, 'table': True, 'graph': False, 'image': False}
...
fcrb_all_3 =  {'tag': 'all', 'source': 'fcrb.medical_specialty', 'fields': ['orgid', 'orgna'], 'key_lookup': {'table': 'fcrb.order_entry', 'key': 'orgid'}, 'table': True, 'graph': False, 'image': False}
...
fcrb_all_9 =  {'tag': 'all', 'source': 'fcrb.professional', 'fields': ['pernr', 'erusr', 'orgid', 'gbdat', 'begdt', 'enddt', 'erdat', 'rank'], 'key_lookup': {'table': 'fcrb.episode', 'key': 'pernr'}, 'table': True, 'graph': False, 'image': False}
