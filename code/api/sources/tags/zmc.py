...
zmc_patient_appointments = {'tag': 'patient_appointments', 'source': 'zmc.registered_events', 'fields': ['patnr', 'type', 'executor', 'location', 'date'], 'key_lookup': {}, 'table': True, 'graph': False, 'image': False}
