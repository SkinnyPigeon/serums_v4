...
os.system('pip3 install pandas sqlalchemy==1.3.24 numpy flask==1.1.2 flask-cors flask-restplus psycopg2 python-dotenv gunicorn tabulate pdf2image pillow==8.3.1 requests pyjwt')
